!(function (e, t) {
    ...
    return (function (e) {
      ...
      function (e, t, n) {
        ...
        function i(e, t, n) {
          return e.addShape('path', { attrs: r({}, n, { path: t }) });
        }
        function a(e) {
          return [
            { x: e.centerX, y: e.minY },
            { x: e.maxX, y: e.centerY },
            { x: e.centerX, y: e.maxY },
            { x: e.minX, y: e.centerY },
          ];
        }
        function c(e, t) {
          var n,
        ...
        function u(e, t) {
          return { x: (e[t].x + e[t + 1].x) / 2, y: (e[t].y + e[t + 1].y) / 2 };
        }
        function s(e, t) {
          var n = e.point,
            r = e.index,
          ...
          return n.x === o.x || n.y === o.y
            ? [n, o]
            : (2 === r && 0 === i) || (0 === r && 2 === i)
            ? [n, { x: n.x, y: (n.y + o.y) / 2 }, { x: o.x, y: (n.y + o.y) / 2 }, o]
            : (2 !== r && 0 !== r) || (3 !== i && 1 !== i)
            ? (1 !== r && 3 !== r) || (2 !== i && 0 !== i)
              ? [n, { x: (n.x + o.x) / 2, y: n.y }, { x: (n.x + o.x) / 2, y: o.y }, o]
              : [n, { x: o.x, y: n.y }, o]
            : [n, { x: n.x, y: o.y }, o];
        }
        function l(e, t) {
        ...
        function d(e, t, n) {
          return l(t, n)
            ? e.x === t[n].x && (e.y - t[n].y) * (e.y - t[n + 1].y) <= 0
            : e.y === t[n].y && (e.x - t[n].x) * (e.x - t[n + 1].x) <= 0;
        }
        function f(e, t) {
          for (var n, r, o, i, a, c = 1 / 0, u = 0; u < t.length - 1; u++) {
            var s = l(t, u),
              f = void 0;
            if (d((f = s ? { x: t[u].x, y: e.y } : { x: e.x, y: t[u].y }), t, u)) {
              var h = ((i = e), (a = f), Math.pow(i.x - a.x, 2) + Math.pow(i.y - a.y, 2));
              c > h && ((c = h), (n = u), (r = f), (o = s));
            }
          }
          return { verticalPoint: r, index: n, vertical: o };
        }
        function h(e, t, n) {
          var r,
            o,
          ...
          if (n) {
            ...
            (r = e.getBBox()),
              (o = l),
              (i = { x: t.getBBox().centerX, y: t.getBBox().centerY }),
              ((r.centerX - o.x) * (r.centerX - i.x) > 0 ||
                (r.centerY - o.y) * (r.centerY - i.y) > 0) &&
                (s = l);
          }
          s = c(s, e.getBBox());
          var d = t.getLinkPoints(s.point)[0];
          return { sourcePoint: s, targetPoint: (d = c(d, t.getBBox())) };
        }
        function g(e, t, n) {
          return l(t, n)
            ? e.minX > t[n].x
        ...
        function p(e, t, n) {
          return l(t, n) ? { x: t[n].x, y: e.y } : { x: e.x, y: t[n].y };
        }
        function m(e) {
          var t;
          switch (e) {
      ...
      function (e, t, n) {
        ...
        function s(e, t, n) {
          var r = [];
          return (
            c.isString(e) ? (r = [t, e]) : c.isArray(e) ? (e.unshift(t), (r = e)) : (r = [t]),
            n && r.unshift(n + '-base'),
            r
          );
        }
              ...
              (r = [
                {
                  ...
                  value: function (e, t) {
                    ...
                    if (1 !== e.length || e[0].isNode || e[0].isGroup) {
                      ...
                      e[0].isEdge
                        ? (n = t.addShape('path', {
                            attrs: o({ path: 'M0 0L 1 1' }, f.edgeDelegationStyle),
                            capture: !1,
                          }))
          ...
          getPanCanvasBehaviour: function (e) {
            return function (t) {
              ...
              a.behaviourOn('canvas:mouseenter', function () {
                t.css({ cursor: i.cursor.beforePanCanvas });
              }),
                a.behaviourOn('mouseleave', function (e) {
                  e.toShape || t.css({ cursor: i.cursor.beforePanCanvas });
                }),
                a.behaviourOn('mousedown', function (o) {
                  ((2 !== o.button && !e) ||
                    ...
                    (o.item &&
                      !1 === o.item.dragable &&
                      'mind-root' !== o.item.shapeObj.type &&
                      !t.getSignal('dragEdge'))) &&
                    ((n = { x: o.domX, y: o.domY }),
                    t.css({ cursor: i.cursor.panningCanvas }),
                    (r = a.getMatrix()),
                    t.setCapture(!1));
                }),
                a.behaviourOn('drag', function (e) {
                  if (n) {
                    ...
                    o.mat3.translate(u, r, [i, c]),
                      t.translateLimt(u) && (a.updateMatrix(u), a.draw());
                  }
                }),
        ...
        var i = n(7),
          ...
          s = r({}, i.Util, a, {
            ...
            getTypeAndChar: function (e) {
              var t;
              for (var n in ((e = '' + e), u))
                for (var r in ((t = n), u[n])) if (r === e) return { type: t, character: u[n][r] };
              return {};
            },
              ...
              (r = [
                  ...
                  value: function () {
                    ...
                    n.on('keydown', function (e) {
                      ...
                      n.on('beforechange', function (t) {
                        'add' === t.action
                          ? e._beforeAdd(t)
                          : 'changeData' === t.action && e._beforeChangeData(t);
                      }),
                      ...
                      this.on('beforedelete', function (t) {
                        var n = t.items[0],
                          ...
                          o = e._getNth(n);
                        r[o - 1]
                          ? e.setSelected(r[o - 1].id, !0)
                          : r[o + 1]
                          ? e.setSelected(r[o + 1].id, !0)
                          : e.setSelected(n.getParent(), !0);
                      }),
                    ...
                    if (e) {
                      ...
                      if (i) {
                        ...
                        (e.hierarchy = a.hierarchy + 1),
                          'mind-placeholder' !== e.shape &&
                            (2 === e.hierarchy && ((e.shape = n), e.side || (e.side = o)),
                  ...
                  value: function (e, t, n) {
                    for (
                      ...
                      for (var s = a[u], l = 0; l < o.length; l++) {
                        var d = o[l],
                          f = d.getBBox();
                        t(f, i, s) && c.push({ long: n(f, i), node: d });
                      }
                    return (
                      c.length > 0 &&
                        (c.sort(function (e, t) {
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (n) {
                      ...
                      'ArrowUp' !== i || n.isRoot
                        ? 'ArrowDown' !== i || n.isRoot
                          ? 'ArrowLeft' === i
                            ? (r = this._arrowLeftItem(n))
                            : 'ArrowRight' === i && (r = this._arrowRightItem(n))
                          : (r = this._arrowBottomItem(n))
                        : (r = this._arrowTopItem(n)),
                        r &&
                          (r = t.find(r.id)).isVisible() &&
                          (this.clearSelected(), this.setSelected(r, !0));
                    }
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function (e) {
                    var t = this.get('_graph'),
                      n = e.model,
                      r = t.find(n.parent);
                    r.getModel().collapsed && t.update(r, { collapsed: !1 }), this._setHierarchy(n);
                  },
                },
                {
                        ...
                        function (n, i, a) {
                          ...
                          if (!n.isPlaceholder && c && c.isVisible()) {
                            var u = (function (e, t, n) {
                                var r = n.children,
                                  o = e;
                                if (!n.parent) for (; r[o] && r[o].side !== t.side; ) o++;
                                for (; r[o] && r[o].isPlaceholder; ) o++;
                                ...
                                e.push({
                                  ...
                                  minY: (function () {
                                    ...
                                    d[a - 1] &&
                                      d[a - 1].isPlaceholder &&
                                      d[a - 1].side === n.side &&
                                      (e = t.find(d[a - 1].id).getBBox().minY);
                                    return e;
                                  })(),
                              ...
                              e.push({
                                ...
                                maxY: (function () {
                                  ...
                                  d[a + 1] &&
                                    d[a + 1].isPlaceholder &&
                                    d[a + 1].side === n.side &&
                                    (e = t.find(d[a + 1].id).getBBox().maxY);
                                  return e;
                                })(),
                                parent: i,
                            ...
                            if (
                              !n.children ||
                              0 === n.children.length ||
                              (1 === n.children.length && n.children[0].isPlaceholder)
                            ) {
                              var p;
                              (p =
                                n.x > i.x
                ...
                },
                {
                  ...
                  value: function (e) {
                    var t;
                    return (
                      this.get('hotAreas').forEach(function (n) {
          ...
          f = (function (e) {
            function t(e) {
              ...
              var r = {
                ...
                arrowController: { thickness: 32, long: 32, controllers: [] },
              };
                    ...
                    return (
                      ...
                      d.addEventListener(o, 'dragstart', function () {
                        var e = o.hoverNode,
                          ...
                          r = e.getBBox(),
                          i = n.getDelegation([{ isEdge: !0 }]);
                        n.setSignal('dragEdge', !0),
                          n.beginAdd('edge', t),
                          n.set('addEdgeConfig', {
                            addModel: t,
                            delegation: i,
                            startPoint: { x: r.centerX, y: r.centerY },
                            sourceItem: e,
                          }),
      ...
      function (e, t) {
        e.exports = {
          gridStyle: { stroke: '#A3B1BF', lineWidth: 0.5 },
                      ...
                      if (n && n.isEdge)
                        if ('add' === r || 'remove' === r) {
                          ...
                          var u = e.find(o.source),
                            ...
                            l = [];
                          if (
                            (d.getParallelEdges(u, s, !0).forEach(function (e) {
                              e.update();
                            }),
      ...
      function (e, t, n) {
        ...
        function h(e) {
          ...
          return (
            e.forEach(function (e) {
              var o = e.model,
                a = i.mix(!0, {}, r({}, o, { id: i.guid() }));
              (t[o.id] = a.id), n.push(r({}, e, { model: a }));
            }),
            n.forEach(function (e) {
              var n = e.model;
              if (n.parent) {
        ...
        (a.list = []),
          ...
          (a.execute = function (e, t, n) {
            ...
            return (
              r.enable(t) &&
                (r.init(),
                r.queue &&
                  (o.queue.splice(o.current, o.queue.length - o.current, r), (o.current += 1)),
                t.emit('beforecommandexecute', { command: r }),
                r.execute(t),
                t.emit('aftercommandexecute', { command: r }),
          ...
          a.registerCommand('common', { back: s }),
          a.registerCommand('copyAdjacent', {
            ...
            execute: function (e) {
              ...
              var c = r.add('node', a),
                u = r.add('edge', { source: o.id, target: a.id });
          ...
          a.registerCommand('update', {
            ...
            execute: function (e) {
              ...
              1 === this.executeTimes &&
                ((this.originModel = i.getContrast(r.getModel(), this.updateModel)), (this.page = t)),
                ...
                t.forEach(function (e) {
                  i.traverseTree(
                    ...
                    function (e) {
                      var t = e.getModel(),
                        r = e.getGraphicGroup();
                      n.clipboard.push({ type: e.type, index: i.getIndex(r), model: t });
                    },
                    function (e) {
          ...
          a.registerCommand('addGroup', {
            ...
            method: function (e) {
              e.getCurrentPage().addGroup({ id: this.addGroupId });
            },
            back: s,
          }),
          ...
          a.registerCommand('delete', {
            ...
            method: function (e) {
              var t = e.getCurrentPage(),
                ...
                r = t.getGraph();
              t.emit('beforedelete', { items: n }),
                i.each(n, function (e) {
                  r.remove(e);
                }),
                t.emit('afterdelete', { items: n }),
          ...
          a.registerCommand('toBack', { enable: c, method: 'toBack', back: s }),
          a.registerCommand('toFront', { enable: c, method: 'toFront', back: s }),
          ...
          a.registerCommand('multiSelect', { enable: l, toMode: 'multiSelect', execute: d, back: f }),
          a.registerCommand('move', { enable: l, toMode: 'move', execute: d, back: f }),
          (e.exports = a);
      },
      function (e, t, n) {
        e.exports = n(2);
      ...
      function (e, t, n) {
        ...
        function o(e) {
          var t = e.graph,
            ...
            u = Object(r.e)({ x: o.x, y: o.y }, c),
            s = u.index,
            l = u.vertical;
          null != s &&
            (i && (a._cursor = n.getGraph().getMouseEventWrapper().style.cursor),
            t.update(a, { hold: { index: s, vertical: l } }),
            l ? n.css({ cursor: 'col-resize' }) : n.css({ cursor: 'row-resize' }));
        }
        function i(e) {
          var t = e.graph,
            n = e.bpmn,
            r = e.item;
          r._cursor && n.css({ cursor: r._cursor }), delete r._cursor, t.update(r, { hold: void 0 });
        }
        function a(e, t) {
          var n = t.item;
          e.update(n, { lastMouse: { x: t.x, y: t.y } });
        }
        function c(e) {
          var t = e.graph,
            n = e.item;
          t.update(n, { lastMouse: void 0, moveDelta: void 0 });
        }
        function u(e, t, n) {
          var r;
          (r =
            t.model && t.model.hold && t.model.hold.vertical
              ? { x: n.x - t.model.lastMouse.x, y: 0 }
              : { x: 0, y: n.y - t.model.lastMouse.y }),
            e.update(t, { edgeMoved: r, modifiedByMouse: !0 });
        }
        function s(e, t, n) {
          var r,
            o = e.model,
          ...
          return (
            i >= 2 &&
              (n
                ? Math.abs(a[i - 2].x - a[i].x) <= 3 &&
                  ...
                  c.push(i - 1, i),
                  (o.hold.index = i - 2),
                  (o.controlPoints[i + 1].x = a[i - 2].x))
                : Math.abs(a[i - 2].y - a[i].y) <= 3 &&
                  ((r = [
                    { x: a[i - 2].x, y: a[i - 2].y },
                    { x: a[i + 1].x, y: a[i - 2].y },
                  ]),
            ...
            i <= a.length - 4 &&
              (n
                ? Math.abs(a[i].x - a[i + 2].x) <= 3 &&
                  (r
                    ? ((r[1] = { x: a[i - 2].x, y: a[i + 3].y }),
                      (o.controlPoints[i + 3].x = a[i - 2].x))
                    : ((r = [
                        { x: a[i + 3].x, y: a[i].y },
                        { x: a[i + 3].x, y: a[i + 3].y },
                      ]),
                  ...
                  c.push(i + 1, i + 2))
                : Math.abs(a[i].y - a[i + 2].y) <= 3 &&
                  (r
                    ? ((r[1] = { x: a[i + 3].x, y: a[i - 2].y }),
                      (o.controlPoints[i + 3].y = a[i - 2].y))
                    : ((r = [
                        { x: a[i].x, y: a[i + 3].y },
                        { x: a[i + 3].x, y: a[i + 3].y },
                      ]),
              ...
              (r = [
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    s.isString(e)
                      ? l.execute(e, this, t)
                      : l.execute('common', this, { method: e }, t);
                  },
                },
                {
                  key: 'commandEnable',
                    ...
                    this.setCommandDOMenable(),
                      ...
                      e.on('contextmenu', function (n) {
                        var r = t.getComponentsByType('contextmenu'),
                          ...
                          a = { x: n.x, y: n.y },
                          c = n.item;
                        c && !c.isSelected && (e.clearSelected(), e.setSelected(n.item, !0)),
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    for (
                      var n = e.shortcutCodes, r = s.getKeyboradKey(t), o = !1, i = 0;
                      i < n.length;
                      i++
                    ) {
                      var a = n[i];
                  ...
                  value: function (e) {
                    ...
                    e.getGraph().on('keydown', function (e) {
                      ...
                      r.forEach(function (e) {
                        ...
                        o.preventDefault();
                      for (
                        var i = l.list.filter(function (e) {
         ...
         */ !(function (t) {
          ...
          (i.getListeners = function (e) {
            ...
            (i.removeListener = function (e, t) {
              ...
              for (r in o) o.hasOwnProperty(r) && -1 !== (n = c(o[r], t)) && o[r].splice(n, 1);
              return this;
            }),
        ...
        Object.defineProperty(t, '__esModule', { value: !0 }),
          (t.default = function (e) {
            for (var t = [], n = (0, i.default)(e), r = d; r > 0; r -= 1) {
              var o = n.toHsv(),
                a = (0, i.default)({ h: h(o, r, !0), s: g(o, r, !0), v: p(o, r, !0) }).toHexString();
              t.push(a);
            }
            t.push(n.toHexString());
            for (var c = 1; c <= f; c += 1) {
              var u = n.toHsv(),
                s = (0, i.default)({ h: h(u, c), s: g(u, c), v: p(u, c) }).toHexString();
              t.push(s);
            }
            return t;
          });
        ...
        function g(e, t, n) {
          ...
          return (
            (r = n
              ...
              : t === f
              ? Math.round(100 * e.s) + c
              : Math.round(100 * e.s) + u * t) > 100 && (r = 100),
            n && t === d && r > 10 && (r = 10),
            r < 6 && (r = 6),
            r
          );
            ...
            var n = (function (e) {
              ...
              'string' == typeof e &&
                (e = (function (e) {
                  ...
                  if ((t = z.hex6.exec(e)))
                    return { r: Y(t[1]), g: Y(t[2]), b: Y(t[3]), format: n ? 'name' : 'hex' };
                  if ((t = z.hex4.exec(e)))
                    return {
                      r: Y(t[1] + '' + t[1]),
                      g: Y(t[2] + '' + t[2]),
              ...
              'object' == typeof e &&
                (H(e.r) && H(e.g) && H(e.b)
                  ? ((h = e.r),
                    (g = e.g),
                    (p = e.b),
                    (t = { r: 255 * X(h, 255), g: 255 * X(g, 255), b: 255 * X(p, 255) }),
                    (d = !0),
                  ...
                  : H(e.h) &&
                    ...
                    (t = (function (e, t, n) {
                      ...
                      if (((e = X(e, 360)), (t = X(t, 100)), (n = X(n, 100)), 0 === t)) r = o = i = n;
                      else {
          ...
          (f.prototype = {
            ...
            getLuminance: function () {
              ...
              return (
                ...
                (t = r.g / 255),
                (n = r.b / 255),
                0.2126 * (e <= 0.03928 ? e / 12.92 : o.pow((e + 0.055) / 1.055, 2.4)) +
                  0.7152 * (t <= 0.03928 ? t / 12.92 : o.pow((t + 0.055) / 1.055, 2.4)) +
            ...
            toName: function () {
              return 0 === this._a
                ? 'transparent'
                : !(this._a < 1) && (B[p(this._r, this._g, this._b, !0)] || !1);
            },
            toFilter: function (e) {
            ...
            (f.mostReadable = function (e, t, n) {
              ...
              return f.isReadable(e, c, { level: i, size: a }) || !o
                ? c
        ...
        r.registerCommand('collapseExpand', {
          ...
          execute: function (e) {
            var t = e.getCurrentPage(),
              n = t.getGraph(),
              r = this.getItem(e);
            r.getModel().collapsed
              ? (n.update(r, { collapsed: !1 }),
                r.getInnerEdges &&
                  r.getInnerEdges().forEach(function (e) {
                    e.update();
                  }),
                (this.toCollapsed = !1))
              : (n.update(r, { collapsed: !0 }), (this.toCollapsed = !0)),
              t.clearSelected(),
              t.setSelected(r, !0),
          ...
          back: function (e) {
            var t = e.getCurrentPage(),
              n = t.getGraph(),
              r = this.getItem(e);
            this.toCollapsed ? n.update(r, { collapsed: !1 }) : n.update(r, { collapsed: !0 }),
              t.clearSelected(),
              t.setSelected(r, !0);
          },
          shortcutCodes: [
          ...
          r.registerCommand(
            'expand',
            {
              enable: function (e) {
                var t = this.getItem(e);
                return (
                  t && !1 !== t.collapseExpand && t.getChildren().length > 0 && t.getModel().collapsed
                );
              },
            },
            'collapseExpand',
        ...
        (i.AUGMENT = {
          _initGraph: function () {
            var e = this.get('graph'),
              t = new (this.get('graphConstructor'))(
                (function (e) {
                  for (var t = 1; t < arguments.length; t++) {
                    var n = null != arguments[t] ? arguments[t] : {},
                      o = Object.keys(n);
          ...
          resetZoom: function () {
            var e = this.get('_graph'),
              t = e.getWidth(),
              n = e.getHeight();
            return e.zoomByDom({ x: t / 2, y: n / 2 }, 1), this;
          },
          css: function (e) {
      ...
      function (e, t, n) {
        ...
        var o = n(36),
          i = n(4),
          a = { CFG: { grid: void 0 }, INIT: '_initGrid' };
        (a.AUGMENT = {
          _initGrid: function () {
            var e = this.get('grid'),
              t = this.get('_graph');
          ...
          showGrid: function (e) {
            ...
            n || (e ? i.isObject(e) && this.set('grid', e) : this.set('grid', !0), this._initGrid()),
              ...
              (r = [
                {
                  key: 'getDefaultCfg',
                  value: function () {
                    return { cell: 16, line: s.gridStyle, type: 'point', visible: !0 };
                  },
                },
                {
                  key: 'init',
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    var c = n.addShape('path', { attrs: r, capture: !1, zIndex: 0 });
                  ...
                  value: function () {
                    for (
                      var e = this.graph,
                        t = e.get('width'),
                        n = e.get('height'),
                        r = e.getPoint({ x: 0, y: 0 }),
                        o = e.getPoint({ x: t, y: n }),
                        i = this.cell,
                        a = Math.ceil(r.x / i) * i,
                        c = Math.ceil(r.y / i) * i,
                        u = [],
      ...
      function (e, t, n) {
        var r = n(4),
          o = {
            CFG: { selectable: !0, multiSelectable: !0, _selectedCache: {} },
            INIT: '_initSelected',
          };
        (o.AUGMENT = {
          ...
          setItemSelected: function (e) {
            ...
            (this.get('_selectedCache')[e.id] = e),
              t && n.attr(t),
              e.isEdge &&
                (e.startArrow && e.startArrow.attr({ fill: t.stroke }),
                e.endArrow && e.endArrow.attr({ fill: t.stroke }));
          },
          clearItemSelected: function (e) {
            ...
            n.attr(u),
              e.isEdge &&
                (e.startArrow && e.startArrow.attr({ fill: u.stroke }),
                e.endArrow && e.endArrow.attr({ fill: u.stroke })),
              delete c[e.id];
          },
              ...
              r.each(n, function (e) {
                r.isString(e) && (e = a.find(e)),
                  e &&
                    !e.destroyed &&
                    (t
                      ? (o.emit('beforeitemselected', { item: e }),
                        o.setItemSelected(e),
                        o.emit('afteritemselected', { item: e }))
                      : (o.emit('beforeitemunselected', { item: e }),
                        o.clearItemSelected(e),
                        o.emit('afteritemunselected', { item: e })),
                    (e.isSelected = t),
                    o.updateStatus(),
                    a.draw());
              }));
      ...
      function (e, t, n) {
        var r = n(4),
          o = { CFG: { activeable: !0, _activedCache: {} }, INIT: '_initActived' };
        (o.AUGMENT = {
          ...
          setItemActived: function (e) {
            ...
            (n[e.id] = e),
              r && o.attr(r),
              e.isEdge &&
                (e.startArrow && e.startArrow.attr({ fill: r.stroke }),
                e.endArrow && e.endArrow.attr({ fill: r.stroke }));
          },
              ...
              r.each(n, function (e) {
                r.isString(e) && (e = a.find(e)),
                  e &&
                    !e.destroyed &&
                    (t
                      ? (o.emit('beforeitemactived', { item: e }),
                        o.setItemActived(e),
                        o.emit('afteritemactived', { item: e }))
                      : (o.emit('beforeitemunactived', { item: e }),
                        o.clearItemActived(e),
                        o.emit('afteritemunactived', { item: e })),
                    (e.isActived = t));
              }),
              a.draw());
          },
      ...
      function (e, t, n) {
        ...
        var u = n(9),
          ...
          l = n(4);
        function d(e, t) {
          return { line: e, point: t, dis: l.pointLineDistance(e[0], e[1], e[2], e[3], t.x, t.y) };
        }
        var f = (function (e) {
          function t() {
            return (
            ...
            (r = [
                ...
                value: function () {
                  ...
                  e.on('afteritemdraw', function (e) {
                    ...
                    if (!l.isEdge(o)) {
                      var i = o.getBBox();
                      !0 === r || 'horizontal' === r
                        ? ((t[o.id + 'tltr'] = [i.minX, i.minY, i.maxX, i.minY, o]),
                          (t[o.id + 'lcrc'] = [i.minX, i.centerY, i.maxX, i.centerY, o]),
                          (t[o.id + 'blbr'] = [i.minX, i.maxY, i.maxX, i.maxY, o]))
                        : 'center' === r &&
                          (t[o.id + 'lcrc'] = [i.minX, i.centerY, i.maxX, i.centerY, o]),
                        !0 === r || 'vertical' === r
                          ? ((n[o.id + 'tlbl'] = [i.minX, i.minY, i.minX, i.maxY, o]),
                            (n[o.id + 'tcbc'] = [i.centerX, i.minY, i.centerX, i.maxY, o]),
                            (n[o.id + 'trbr'] = [i.maxX, i.minY, i.maxX, i.maxY, o]))
                          : 'center' === r &&
                            (n[o.id + 'tcbc'] = [i.centerX, i.minY, i.centerX, i.maxY, o]);
                    }
                  }),
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  return (
                    this.grid && r && r.visible && this._gridAlign(e, t),
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  var r = this._horizontalLines,
                    ...
                    i = this.tolerance,
                    a = { x: n.x + t.width / 2, y: n.y },
                    c = { x: n.x + t.width / 2, y: n.y + t.height / 2 },
                    u = { x: n.x + t.width / 2, y: n.y + t.height },
                    s = { x: n.x, y: n.y + t.height / 2 },
                    f = { x: n.x + t.width, y: n.y + t.height / 2 },
                    h = [],
                    g = [],
                    p = null;
                  if (
                    ...
                    (e.y = h[0].line[1] - h[0].point.y + n.y),
                      (p = { type: 'item', horizontals: [h[0]] });
                    for (var m = 1; m < 3; m++) h[0].dis === h[m].dis && p.horizontals.push(h[m]);
                  }
                  if (0 !== g.length && g[0].dis < i) {
                    (e.x = g[0].line[0] - g[0].point.x + n.x),
                      p ? (p.verticals = [g[0]]) : (p = { type: 'item', verticals: [g[0]] });
                    for (var y = 1; y < 3; y++) g[0].dis === g[y].dis && p.verticals.push(g[y]);
                  }
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  'item' === e.type &&
                    (e.horizontals &&
                      l.each(e.horizontals, function (e) {
                        var i,
                          a,
                          c = e.line,
                          u = e.point,
                          s = (c[0] + c[2]) / 2;
                        u.x < s
                          ? ((i = u.x - t.width / 2), (a = Math.max(c[0], c[2])))
                          : ((i = u.x + t.width / 2), (a = Math.min(c[0], c[2])));
                        var d = n.addShape('line', {
                          attrs: l.mix({ x1: i, y1: c[1], x2: a, y2: c[1] }, r),
                          capture: !1,
                        });
                        o.push(d);
                      }),
                    e.verticals &&
                      l.each(e.verticals, function (e) {
                        var i,
                          a,
                          c = e.line,
                          u = e.point,
                          s = (c[1] + c[3]) / 2;
                        u.y < s
                          ? ((i = u.y - t.height / 2), (a = Math.max(c[1], c[3])))
                          : ((i = u.y + t.height / 2), (a = Math.min(c[1], c[3])));
                        var d = n.addShape('line', {
                          attrs: l.mix({ x1: c[0], y1: i, x2: c[0], y2: a }, r),
                          capture: !1,
                        });
                        o.push(d);
                      }));
      ...
      function (e, t, n) {
        var r = n(4),
          o = { CFG: { labelEditable: !1 }, INIT: '_initLabelEditor' };
        (o.AUGMENT = {
          ...
          setLabelEditorBeginPosition: function (e) {
            ...
            if (n) {
              ...
              t.css({ top: c.y + 'px', left: c.x + 'px' }), (t.labelPoint = c);
            } else {
              var u = this.getGraph().getRootGroup(),
                s = e.getKeyShape(),
                l = r.getBBox(s, u),
                d = { x: l.minY + (l.maxY - l.minY - t.height()) / 2, y: (l.minX + l.maxX) / 2 };
              t.css({ top: d.x + 'px', left: d.y + 'px' }), (t.labelPoint = d);
            }
          },
          beginEditLabel: function (e) {
            ...
            if ((r.isString(e) && (e = n.find(e)), e && !e.destroyed && t)) {
              ...
              } else (t.innerHTML = ''), t.css({ 'min-width': 'auto', 'min-height': 'auto' });
          ...
          endEditLabel: function () {
            ...
            if ((this.setSignal('preventWheelPan', !1), e)) {
              ...
              if (t) {
                var n = t.getModel(),
                  r = this.editor;
                n.label !== e.textContent &&
                  r.executeCommand('update', {
                    action: 'updateLabel',
                    itemId: t.id,
                    updateModel: { label: e.textContent },
                  }),
                  e.hide(),
                  (e.focusItem = void 0),
            ...
            updateStatus: function () {
              ...
              0 === t.length
                ...
                ? t[0].isNode
                  ...
                  : t[0].isEdge
                  ? (e = 'edge-selected')
                  : t[0].isGroup && (e = 'group-selected')
                : (e = 'multi-selected'),
                this.emit('statuschange', { status: e });
            },
          },
        };
        e.exports = n;
      ...
      function (e, t, n) {
        n(3).registerBehaviour('hoverButton', function (e) {
          e.getGraph().behaviourOn('mouseenter', function (t) {
            e.getSignal('panningItem') ||
              (t.shape && t.shape.isButton && e.css({ cursor: 'pointer' }));
          });
        });
      },
      function (e, t, n) {
              ...
              i.throttle(function (r) {
                ...
                if (c) {
                  ...
                  if (Math.abs(u) > 10) {
                    var s = n.getMatrix()[0];
                    u > 0
                      ? n.zoom({ x: r.x, y: r.y }, 1.05 * s)
                      : n.zoom({ x: r.x, y: r.y }, s * (1 / 1.05));
                  }
                } else {
                  var l = [],
                    d = n.getMatrix();
                  var whxx = a.wheelDeltaX;
                  var whyy = a.wheelDeltaY;
                                  // fix ie11 
                  if (!whxx) whxx = a.deltaX;
                  if (!whyy) whyy = a.deltaY;
  
                  i.mat3.translate(l, d, [whxx * o.wheelPanRatio, whyy * o.wheelPanRatio]),
          ...
          t.behaviourOn('mousemove', function (n) {
            ...
            if (r) {
              var o = e.get('panItemStartPoint'),
                ...
                a = n.x - o.x,
                c = n.y - o.y,
                u = e.align({ x: i.minX + a, y: i.minY + c }, { width: i.width, height: i.height });
              r.attr({ x: u.x, y: u.y }), t.emit('itempanning', n), t.draw();
            }
          });
        });
      },
          ...
          t.behaviourOn('dragstart', function (r) {
            if (2 !== r.button && r.item && (r.item.isNode || r.item.isGroup)) {
              var o,
                i = r.item;
              if (
                (o = (o = i.isSelected ? e.getSelected() : [i]).filter(function (e) {
                  return e.isNode || e.isGroup;
                }))[0] &&
                !1 !== o[0].dragable
              ) {
                t.emit('beforepanitem', { items: o }), t.emit('beforeshowdelegation', { items: o });
                ...
                e.setSignal('panningItem', !0),
                  ...
                  e.set('panItemStartPoint', { x: r.x, y: r.y }),
                  t.draw();
              }
            }
          });
        ...
        n(3).registerBehaviour('clickCollapsedButton', function (e) {
          ...
          t.behaviourOn('click', function (n) {
            ...
            if (r && o && o.isCollapsedButton) {
              var i = e.editor;
              i
                ? i.executeCommand('collapseExpand', { itemId: r.id })
                : t.update(r, { collapsed: !0 });
            }
          });
        });
      },
      function (e, t, n) {
        n(3).registerBehaviour('clickEdgeSelected', function (e) {
          e.getGraph().behaviourOn('edge:click', function (t) {
            e.get('multiSelectable') && !0 === e.getSignal('shiftKeyDown')
              ? e.setSelected(t.item.id, !0)
              : (e.clearActived(), e.clearSelected(), e.setSelected(t.item.id, !0));
          });
        });
      },
      function (e, t, n) {
      ...
      function (e, t, n) {
        n(3).registerBehaviour('hoverNodeActived', function (e) {
          ...
          n.behaviourOn('node:mouseenter', function (n) {
            !1 !== n.item.getShapeObj().panAble && e.css({ cursor: 'move' }),
              e.getSignal('panningItem') ||
                e.getSignal('dragEdge') ||
                (n.item && n.item.isSelected) ||
                ((t = n.item), e.setActived(t, !0));
          }),
            n.behaviourOn('node:mouseleave', function (n) {
              var r = n.toShape;
              t &&
                ((r && r.isAnchor && r.getItem() === t) ||
                  e.getSignal('dragEdge') ||
                  (t.isSelected || e.setActived(t, !1), (t = void 0)));
            });
        });
      },
      function (e, t, n) {
        n(3).registerBehaviour('hoverGroupActived', function (e) {
          ...
          t.behaviourOn('mouseenter', function (t) {
            e.getSignal('panningItem') ||
              (t.item && t.item.isSelected) ||
              e.getSignal('dragEdge') ||
              (t.shape &&
                t.shape.isGroupKeyShape &&
                (e.css({ cursor: 'move' }), e.setActived(t.item, !0)));
          }),
        ...
        e.exports = {
          dragingEdgeEndPoint: function (e) {
            var t = e.endPointType,
              ...
              l = 'source' === t ? [a, i] : [i, a];
            s && ('source' === t ? (u = s) : (c = s));
            var d = r.getShapeObj('edge', n).getPathByPoints({ points: l, source: c, target: u });
          ...
          panGroup: function (e, t, n, o) {
            ...
            r.traverseTree(
              ...
              function (r) {
                if ('node' === r.type) {
                  var i = r.getModel();
                  o.update(r, { x: i.x + t, y: i.y + n });
                }
                e.getCrossEdges &&
                  e.getCrossEdges().forEach(function (e) {
                    e.update();
                  });
              },
              function (e) {
            ...
            if ((o.getGraph().emit('beforedropedge'), s)) {
              if (a && s.isAnchor && s.hasHotspot) {
                var f = s,
                  h = f.getItem();
                return 'target' === n
                  ? ((r.target = h.id), (r.targetAnchor = f.getIndex()), !0)
                  : ((r.source = h.id), (r.sourceAnchor = f.getIndex()), !0);
              }
              if (c && u && u.isNode)
                return 'target' === n ? ((r.target = u.id), !0) : ((r.source = u.id), !0);
            } else if (i)
              return 'target' === n
                ? ((r.target = { x: l, y: d }), !0)
                : ((r.source = { x: l, y: d }), !0);
        ...
        (r.AUGMENT = {
          ...
          addGroup: function (e) {
            var t,
              ...
              i = !0;
            if (0 !== r.length) {
              e || (e = { label: '新建分组' }), o.setId(e), n.add('group', e), n.toFront(e.id);
              var a = n.find(e.id);
              if (
                (r.forEach(function (e) {
                  var n = e.getParent();
                    ...
                    this._clearAnchor(e),
                      f.each(i, function (i, a) {
                        if (!n || -1 !== n.indexOf(a)) {
                          var c,
                            u = t.addShape('marker', {
                              attrs: o({ symbol: 'circle' }, d.anchorPointStyle, { x: i.x, y: i.y }),
                              freezePoint: i,
                              item: e,
                              index: a,
                              eventPreFix: 'anchor',
                          ...
                          u.toFront(),
                            ...
                            (u.showHotspot = function () {
                              (c = t.addShape('marker', {
                                attrs: o({ symbol: 'circle' }, d.anchorHotsoptStyle, {
                                  x: i.x,
                                  y: i.y,
                                }),
                                freezePoint: i,
                            ...
                            (u.setHotspotActived = function (e) {
                              c &&
                                (e
                                  ? c.attr(d.anchorHotsoptActivedStyle)
                                  : c.attr(d.anchorHotsoptStyle));
                            }),
                            r && u.showHotspot(),
      ...
      function (e, t, n) {
        ...
        var o = n(69),
          i = { CFG: { orbit: null }, INIT: '_initOrbit' };
        (i.AUGMENT = {
          _initOrbit: function () {
                  ...
                  value: function () {
                    ...
                    n.getGraph().addBehaviour('orbit'),
                      t.forEach(function (t) {
                        g(t)
                          ? e.satelliteCache.push(new d[t](r))
                          : e.satelliteCache.push(
                              new d(
                                (function (e) {
                                  for (var t = 1; t < arguments.length; t++) {
                                    var n = null != arguments[t] ? arguments[t] : {},
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    d.forEach(function (e) {
                      var t = e.getDOM(),
                        n = t.width() / 2,
                        o = r.getDomPoint({ x: m[0] + a, y: m[1] + c });
                      t.css({ top: o.y - n + 'px', left: o.x - n + 'px' });
                    });
                  },
                },
                {
                          ...
                          [
                            l.addEventListener(e, 'dragstart', function () {
                              var r = n.item,
                                a = (function (e) {
                                  ...
                                  return e;
                                })({}, t.get('addEdgeModel'), { source: r.id }),
                                c = r.getBBox(),
                                u = t.getDelegation([{ isEdge: !0 }], i);
                              t.setSignal('dragEdge', !0),
                                t.beginAdd('edge', a),
                                t.set('addEdgeConfig', {
                                  addModel: a,
                                  delegation: u,
                                  startPoint: { x: c.centerX, y: c.centerY },
                                  sourceItem: r,
                                }),
                                e.hide();
                            }),
                            l.addEventListener(e, 'click', function (e) {
                              var o = e.clientX,
                                ...
                                a = t.editor,
                                c = n.item,
                                u = r.getPointByClient({ x: o, y: i }),
                                s = c.getBBox(),
                                d = c.getModel(),
                                f = [u.x - s.centerX, u.y - s.centerY],
                                h = l.vec2.length(f);
                              if ((l.vec2.scale(f, f, 160 / h), a))
      ...
      function (e, t, n) {
        ...
        function a(e) {
          e.controlPointShapes &&
            r.each(e.controlPointShapes, function (e) {
              e.remove();
            }),
            (e.controlPointShapes = []),
        ...
        (i.INIT = '_initResize'),
          (i.CFG = { nodeResizeable: !1, edgeResizeable: !0 }),
          (i.AUGMENT = {
            _initResize: function () {
              ...
              n &&
                ...
                t.on('afteritemhide', function (e) {
                  var t;
                  e.item.isControlPointShow &&
                    ((t = e.item).controlPointShapes &&
                      r.each(t.controlPointShapes, function (e) {
                        e.hide();
                      }),
                ...
                : 'edge' === e.type &&
                  ...
                  r.each(d, function (e, i) {
                    var a = n.addShape('marker', {
                      attrs: r.mix({}, o.edgeControlPointStyle, { x: e.x, y: e.y }),
                      freezePoint: { x: e.x, y: e.y },
                      item: t,
                    });
      ...
      function (e, t, n) {
        ...
        (a.AUGMENT = {
          addOutterShape: function (e, t) {
            ...
            var d = a.addShape(u, { attrs: r({}, l, { fill: null }, t) });
            i.toBack(d, a);
            var f = d.getBBox(),
              h = f.maxX - f.minX,
              g = f.maxY - f.minY,
          ...
          AUGMENT: {
            _initLink: function () {
              ...
              n &&
                ...
                t.changeMode(o)),
                r &&
                  (t.addBehaviour('hoverNodeAddOutter', 'add'),
      ...
      function (e, t, n) {
        ...
        i.registerNode('diagram-base', {
          ...
          getStyle: function (e) {
            ...
            return a.mix(!0, {}, this.getDefaulStyle(), { fill: t, stroke: n }, r.style);
          },
          getPath: function (e) {
          ...
          getSelectedOutterStyle: function (e) {
            ...
            if (t) {
              ...
              return r({}, c.nodeSelectedOutterStyle, { stroke: n[1], fill: n[1] });
            }
        ...
        r.registerEdge('diagram-base', {
          getPath: function (e) {
            var t = e.getPoints(),
              n = e.getSource(),
              r = e.getTarget();
            return this.getPathByPoints({ points: t, source: n, target: r, item: e });
          },
          ...
          getStyle: function (e) {
            var t = e.getModel();
            return o.mix(!0, {}, i.edgeStyle, { stroke: t.color }, t.style);
          },
          getActivedStyle: function () {
      ...
      function (e, t, n) {
        ...
        var i = n(13),
          ...
          d = { fill: '#CED4D9' },
          f = { stroke: '#697B8C', fill: '#fff', fillOpacity: 0 },
          h = { stroke: '#697B8C', fill: '#fff', fillOpacity: 0 },
          g = { fill: '#000000', textBaseline: 'top', textAlign: 'left' },
          p = { stroke: '#CED4D9', fill: '#F2F4F5', radius: 4 },
        ...
        i.registerGroup('diagram-base', {
          draw: function (e) {
            ...
            if (
              (o.minX === 1 / 0 &&
                ((o.minX = t.x), (o.maxX = t.x + O), (o.minY = t.y), (o.maxY = t.y + P)),
              a && ((o.minX = o.maxX - O), (o.maxY = o.minY + P)),
              o.maxX - o.minX < O)
            ) {
            ...
            var C = (function (e, t) {
              ...
              M = (function (e, t, n, o) {
                var i = t.addShape('path', { attrs: r({}, o, { path: n }) });
                return (i.isGroupKeyShape = !0), i;
              })(0, n, c.getRectPath(C, E, k, A, i.radius), i);
            return (
              (function (e, t, n, r) {
                var o = c.mix(!0, {}, g, { x: n + y, y: r + v });
                c.isString(e) ? (o.text = e) : c.mix(o, e), t.addShape('text', { attrs: o });
              })(c.isNil(t.label) ? '新建分组' : t.label, n, C, E),
              (function (e, t, n, o) {
                var i = t.addShape('path', { attrs: r({ path: e }, d) }),
                  a = i.getBBox();
              ...
              ((function (e, t, n, o, i) {
                var a;
                if (e) {
                  var c = (a = t.addShape('path', { attrs: r({ path: l }, h) })).getBBox(),
                    u = c.maxX - c.minX;
                  (a.isExpandedButton = !0), a.translate(n + i - c.minX - u - x, o - c.minY + b);
                } else {
                  var d = (a = t.addShape('path', { attrs: r({ path: s }, f) })).getBBox(),
                    g = d.maxX - d.minX;
          ...
          getStyle: function (e) {
            var t = e.getModel();
            return c.mix(!0, {}, p, { fill: t.color, stroke: t.color }, t.style);
          },
          getActivedStyle: function () {
            ...
            t.behaviourOn('drop', function () {
              ...
              if (n) {
                var r = n[0],
                  ...
                  s = a.attr('x') - c.minX,
                  l = a.attr('y') - c.minY;
                t.emit('afterpanitemdrop', { panItems: n }), e.clearAlignLine();
                var d = e.editor;
                t.emit('panitemend'),
              ...
              function f() {
                i.forEach(function (e) {
                  ...
                  n.isGroup
                    ? o.panGroup(n, s, l, t)
                    : (t.update(n, { x: r.x + s, y: r.y + l }), t.toFront(n));
                }),
          ...
          t.behaviourOn('anchor:mouseenter', function (n) {
            if (!e.getSignal('panningItem') && !e.getSignal('dragEdge')) {
              var o = n.shape,
                ...
                u = (function (e) {
                  ...
                  return e;
                })({}, e.get('addEdgeModel'), { source: c.id }),
                s = { anchor: o.getPoint(), item: a };
              e.emit('hoveranchor:beforeaddedge', s),
                s.cancel
                  ? e.css({ cursor: i.cursor.hoverUnEffectiveAnchor })
                  : (e.css({ cursor: i.cursor.hoverEffectiveAnchor }),
            ...
            t.behaviourOn('anchor:mouseleave', function (n) {
              if (!e.getSignal('dragEdge') && !e.getSignal('panningItem')) {
                var r = n.shape,
                  o = r.getItem();
                e.css({ cursor: i.cursor.beforePanCanvas }),
                  o.isSelected || (e.clearAnchor(o), e.setActived(o, !1)),
      ...
      function (e, t, n) {
        ...
        r.registerBehaviour('hoverEdgeControlPoint', function (e) {
          e.getGraph().behaviourOn('edgeControlPoint:mouseenter', function (t) {
            if (!e.getSignal('dragEdge') && !e.getSignal('panningItem')) {
              var n = t.shape;
              (n.isTargetEndPoint() || n.isSourceEndPoint()) &&
                e.css({ cursor: o.cursor.hoverEdgeControllPoint });
            }
          });
        });
      },
          ...
          function (e) {
            ...
            function p(g) {
              if (r) {
                ...
                if (m) {
                  var v = e.editor;
                  v ? v.executeCommand('update', { itemId: y, updateModel: p }) : h.update(y, p);
                }
            ...
            h.behaviourOn('edgeControlPoint:mousedown', function (o) {
              if (2 !== o.button) {
                ...
                i.isTargetEndPoint()
                  ...
                  : i.isSourceEndPoint() &&
                    ...
                    (l = f.targetAnchor)),
                  d &&
                    ((r = e.getDelegation([d], g)),
                    c
                      ? e.dragEdgeBeforeShowAnchor(c, s, 'target')
                      : u && e.dragEdgeBeforeShowAnchor(u, l, 'source'),
                    h.hide(d),
              ...
              h.behaviourOn('edgeControlPoint:mouseleave', function (r) {
                t || n || r.toShape || e.css({ cursor: o.cursor.beforePanCanvas });
              }),
        ...
        r.registerBehaviour(
          ...
          function (e) {
            ...
            c.behaviourOn('canvas:mouseenter', function (c) {
              if (
                !n &&
                ((i = e.get('addType')), (a = e.get('addModel')), (a = o.clone(a)), 'node' === i)
              ) {
                ...
                (t = {
                  ...
                  e.set('panItemStartPoint', { x: c.x, y: c.y });
              }
            }),
              c.behaviourOn('mouseup', function (t) {
                if (n) {
                  ...
                  n.remove(),
                    ...
                    e.clearSelected(),
                    e.focusGraphWrapper(),
                    u ? u.executeCommand('add', { type: 'node', addModel: a }) : c.add(r, a),
      ...
      function (e, t, n) {
        ...
        r.registerBehaviour('dragMultiSelect', function (e) {
          var t,
            ...
            i = r.getRootGroup();
          function a() {
            e.css({ cursor: o.cursor.beforePanCanvas }), (t = void 0), (n = void 0);
          }
          e.css({ cursor: o.cursor.multiSelect }),
            r.behaviourOn('dragstart', function (e) {
              2 !== e.button &&
                ((t = { x: e.x, y: e.y }),
                (n = i.addShape('rect', { attrs: o.multiSelectRectStyle })));
            }),
        ...
        r.registerBehaviour('dragNodeAddToGroup', function (e) {
          ...
          r.behaviourOn('dragenter', function (i) {
            ...
            r.behaviourOn('dragleave', function () {
              n && t && r.update(n, { padding: void 0, style: void 0 });
            }),
            ...
            r.behaviourOn('canvas:mouseleave', function () {
              n && (r.update(n, { padding: void 0, style: void 0 }), i());
            });
        });
      },
      function (e, t, n) {
        ...
        r.registerBehaviour('dragOutFromGroup', function (e) {
          ...
          function u() {
            clearTimeout(r),
              n && a.update(n, { padding: void 0, style: void 0 }),
              (c = !1),
              (t = void 0),
              (n = void 0);
          }
          a.behaviourOn('drag', function (u) {
            ...
            a.on('drop', function (e) {
              n &&
                t &&
                !e.shape &&
                (a.update(t, { parent: void 0 }), a.update(n, { style: void 0 }), u());
            }),
              ...
              if (a) {
                ...
                if (u)
                  t.getNodes().forEach(function (t) {
                    ...
                    e.css({ cursor: i.cursor.beforePanCanvas }),
                    u.remove(),
                    o.dropUpdateEdge({ ev: r, endPointType: 'target', model: c, diagram: e }) &&
                      (l ? l.executeCommand('add', { type: 'edge', addModel: c }) : t.add('edge', c)),
                    t.draw(),
                    e.endAdd(),
                    n();
                else n();
      ...
      function (e, t, n) {
        n(1).registerBehaviour('hoverNodeAddOutter', function (e) {
          ...
          n.behaviourOn('node:mouseenter', function (n) {
            ...
            e.getSignal('dragEdge') &&
              ((t = r),
              e.addOutterShape(r, { stroke: '#52C41A', strokeOpacity: 0.45, lineWidth: 4 }));
          }),
        ...
        r.registerBehaviour('orbit', function (e) {
          ...
          n.behaviourOn('beforepanitem', function () {
            ...
            n.behaviourOn('mousemove', function (r) {
              ...
              if (t) {
                var s = t.getBBox(),
                  l = i.euclideanDistance.pointPoint({ x: s.centerX, y: s.centerY }, { x: c, y: u }),
                  d = n.getMatrix()[0];
                a !== t && l > s.width / 2 + o.orbitGap / d && (e.hideOrbit(), (t = void 0)),
                  t && e.layoutOrbit(t, { x: c, y: u });
              }
            });
        });
      },
      ...
      function (e, t, n) {
        ...
        function i(e, t, n, r) {
          ...
          return (
            (s =
              Math.abs(t - n) < 2 * Math.abs(t - e)
                ? (r * Math.abs(t - n)) / (2 * Math.abs(t - e))
                : r) > i && (s = i),
            s < o && (s = o),
            t > e ? s : -s
          );
        ...
        function a(e, t, n, r) {
          ...
          return (
            r && r.bbox && (s = Math.min(s, r.bbox.height, r.bbox.width)),
      ...
      function (e, t, n) {
        ...
        function l(e, t) {
          return (
            2 * Math.abs(e.centerX - t.centerX) < e.width + t.width &&
            2 * Math.abs(e.centerY - t.centerY) < e.height + t.height
          );
        }
        function d(e) {
          var t = e.x,
            n = e.y;
          return { centerX: t, centerY: n, minX: t, minY: n, maxX: t, maxY: n, height: 0, width: 0 };
        }
        function f(e, t) {
        ...
        function h(e, t) {
          return (function (e, t) {
            ...
            ? { x: t.x > e.centerX ? e.maxX : e.minX, y: t.y }
            : { x: t.x, y: t.y > e.centerY ? e.maxY : e.minY };
        }
        function g(e) {
          var t = e.minX,
            n = e.minY,
              ...
              (g = m),
                ...
                (function (e, t, n, r) {
                  ...
                  return (
                    e.forEach(function (e) {
                      e !== t &&
                        ((e.x !== t.x && e.y !== t.y) || y(e, t, n) || y(e, t, r) || o.push(e));
                    }),
                    x(o)
                  );
                  ...
                  if (-1 === u.indexOf(e)) {
                    ...
                    var r = f[m.id] + S(m, e);
                    (d[e.id] && r >= d[e.id]) ||
                      ((l[e.id] = m.id), (d[e.id] = r), (f[e.id] = d[e.id] + w(e, n, t, a, c)));
                  }
                });
            };
            s.length;
                  ...
                  var u = o(
                      (function (e, t, n, r) {
                        ...
                        return (
                          ...
                          i < r && (r = i),
                          [
                            { x: t.x - (r / o) * (t.x - e.x), y: t.y - (r / o) * (t.y - e.y) },
                            { x: t.x - (r / i) * (t.x - n.x), y: t.y - (r / i) * (t.y - n.y) },
                          ]
                        );
                      })(r, a, c, t),
                      2,
                ...
                : (0 === c.length && s--,
                  (function (e, t, n) {
                    var r = e.getBBox(),
                      ...
                      c = r.centerY,
                      u = 20 * (n + 1),
                      s = [0.5 * (o.centerX + a) - a, 0.5 * (o.centerY + c) - c],
                      l = [-s[1], s[0]],
                      d = i.length(l);
                    i.scale(l, l, u / d);
                    var f = { x: s[0] + l[0] + a, y: s[1] + l[1] + c },
          ...
          function (e) {
            ...
            i.behaviourOn('beforeshowdelegation', function () {
              ...
              i.behaviourOn('node:dragstart', function (e) {
                if (2 !== e.button) {
                  var r = e.item;
                  !(t = r.getModel()).parent || e.shape.isCollapsedButton || e.shape.isExpandedButton
                    ? c()
                    : ((n = i.getNth(r)), i.remove(r));
                }
              }),
              i.behaviourOn('itempanning', function (t) {
                if (!t.shape || !t.shape.isPlaceholder) {
                  var n = e.getHotArea(t),
                    o = e.getRoot();
                  if (
                    (r && (n ? r.id !== n.id && i.remove(i.find(r.id)) : i.remove(i.find(r.id))),
                    (r = n),
                    n)
                  ) {
                    var a = n.parent;
      ...
      function (e, t, n) {
        ...
        var i = n(8),
          a = n(10),
          c = { fill: '#000', textAlign: 'left', textBaseline: 'top' },
          u = { stroke: '#959EA6', strokeOpacity: 0, fill: '#959EA6', cursor: 'pointer' },
          s = { stroke: '#434B54', fill: '#fff', cursor: 'pointer' };
        i.registerNode('mind-base', {
          ...
          debugDrawLayoutPoint: function (e) {
            var t = e.getModel();
            e.getGraphicGroup().addShape('circle', { attrs: { x: t.x, y: t.y, r: 5, fill: 'red' } });
          },
          drawExpandedButton: function (e) {
            var t = e.getKeyShape().getBBox(),
              n = e.getGraphicGroup().addGroup(),
              o = n.addShape('path', { attrs: r({ path: a.getRectPath(0, 0, 16, 7, 3) }, u) }),
              i = o.getBBox(),
              c = a.getMindNodeSide(e),
              s = this.getButtonPositon(t, i, c),
              l = { fill: 'white', r: 1 };
            n.addShape('circle', { attrs: r({}, l, { x: 4, y: 3.5 }), capture: !1 }),
              n.addShape('circle', { attrs: r({}, l, { x: 8, y: 3.5 }), capture: !1 }),
              n.addShape('circle', { attrs: r({}, l, { x: 12, y: 3.5 }), capture: !1 }),
          ...
          drawCollapsedButton: function (e) {
            var t = e.getKeyShape().getBBox(),
              n = e
                .getGraphicGroup()
                .addShape('path', { attrs: r({ path: a.getCollapsedButtonPath() }, s) }),
              o = n.getBBox(),
          ...
          getButtonPositon: function (e, t, n) {
            return 'right' === n
              ? { x: e.maxX + 2, y: e.maxY - (t.maxY - t.minY) / 2 }
              : { x: e.minX - (t.maxX - t.minX) - 2, y: e.maxY - (t.maxY - t.minY) / 2 };
          },
          getLabel: function (e) {
          ...
          drawLabel: function (e) {
            ...
            n || (n = ' ');
            var o = a.mix(!0, {}, c, r, { x: 0, y: 0 });
            a.isObject(n) ? a.mix(o, n) : (o.text = n);
            var i = t.addShape('text', { class: 'label', attrs: o });
          ...
          adjustLabelPosition: function (e, t) {
            var n = this.getSize(e),
              ...
              o = n[0],
              i = t.getBBox();
            t.attr({ x: -o / 2 + r[3], y: -i.height / 2 + this.dy });
          },
      ...
      function (e, t, n) {
        ...
        r.registerNode(
          'mind-root',
          {
            adjustLabelPosition: function (e, t) {
              var n = t.getBBox();
              t.attr({ x: -n.width / 2, y: -n.height / 2 - 1 });
            },
            getPath: function (e) {
              var t = this.getSize(e),
                n = this.getStyle(e);
            ...
            getButtonPositon: function (e, t, n) {
              return 'right' === n
                ? { x: e.maxX + 2, y: (e.maxY + e.minY) / 2 - (t.maxY - t.minY) / 2 }
                : {
      ...
      function (e, t, n) {
        n(8).registerEdge('mind-edge', {
          getEdetal: function (e) {
            return e.children && e.children.length > 0 && !e.collapsed
              ? 2 === e.hierarchy
                ? 24
                : 18
              : 0;
          ...
          getPath: function (e) {
            ...
            if (a.hierarchy >= 3) {
              ...
              if (o.centerX < i.centerX) {
                ...
                return [
                  ['M', t[0].x, t[0].y],
                  ['M', h, t[0].y],
                  ['C', h + u, t[0].y, i.minX - c, i.maxY, i.minX, i.maxY],
                  ['L', i.maxX + f, i.maxY],
                ];
              }
              var g = t[0].x - d;
              return [
                ['M', t[0].x, t[0].y],
                ['M', g, t[0].y],
                ['C', g - u, t[0].y, i.maxX + c, i.maxY, i.maxX, i.maxY],
                ['L', i.minX - f, i.maxY],
              ];
            }
            ...
            return o.centerX < i.centerX
              ? [
                  ['M', t[0].x, t[0].y],
                  ['C', t[0].x + u, t[0].y, i.minX - c, i.maxY, i.minX, i.maxY],
                  ['L', i.maxX + p, i.maxY],
                ]
              : [
                  ['M', t[0].x, t[0].y],
                  ['C', t[0].x - u, t[0].y, i.maxX + c, i.maxY, i.maxX, i.maxY],
                  ['L', i.minX - p, i.maxY],
                ];
          },
          getStyle: function (e) {
      ...
      function (e, t, n) {
        ...
        n(8).registerEdge('mind-placeholder-edge', {
          getOriginShapeObject: function (e) {
            return e.getGraph().getShapeObj('edge', { shape: 'mind-edge' });
          },
          getPath: function (e) {
          ...
          getStyle: function (e) {
            return (function (e) {
              ...
              return e;
            })({}, this.getOriginShapeObject(e).getStyle(e), { stroke: '#91D5FF' });
          },
        });
      },
      function (e, t, n) {
        ...
        r.registerCommand('append', {
          ...
          execute: function (e) {
            var t,
              ...
              u = c.hierarchy,
              s = a.getParent();
            if (a.isRoot) t = i(n, a, this.addItemId);
            else {
              var l = r.getNth(a);
              t = r.add('node', {
                id: this.addItemId,
            ...
            n.clearSelected(),
              ...
              n.setSelected(t, !0),
              1 === this.executeTimes &&
                ((this.selectedItemId = a.id), (this.addItemId = t.id), n.beginEditLabel(t));
          },
          back: function (e) {
            var t = e.getCurrentPage();
          ...
          r.registerCommand('appendChild', {
            ...
            execute: function (e) {
              var t,
                ...
                o = this.getItem(e);
              (t = o.isRoot
                ? i(n, o, this.addItemId)
                : r.add('node', { id: this.addItemId, parent: o.id, label: '新建节点' })),
                n.clearSelected(),
                n.clearActived(),
                n.setSelected(t, !0),
                1 === this.executeTimes &&
                  ((this.selectedItemId = o.id), (this.addItemId = t.id), n.beginEditLabel(t));
            },
            back: function (e) {
              var t = e.getCurrentPage();
              t.getGraph().remove(this.addItemId),
          ...
          r.registerCommand('moveMindNode', {
            ...
            execute: function (e) {
              ...
              delete c.shape, delete c.side, n.remove(c.id), o.mix(c, { parent: r, nth: i, side: a });
              var u = n.add('node', c);
        ...
        n(12).registerBehaviour(
          ...
          function (e) {
            ...
            n.behaviourOn('edge:mouseenter', function (t) {
              !i && t.item && ((a = t.item), u({ graph: n, bpmn: e, ev: t, backUpCursor: !0 }));
            }),
              ...
              n.behaviourOn('mouseup', function () {
                i && (f({ graph: n, item: i }), (i = void 0));
              }),
              n.behaviourOn('mousemove', function (t) {
                i
                  ? d(n, i, t)
                  : a && u({ graph: n, bpmn: e, ev: r({}, t, { item: a }), backUpCursor: !1 });
              }),
              n.behaviourOn('edge:mouseleave', function () {
                i || (a && (l({ graph: n, bpmn: e, item: a }), (a = void 0)));
              }),
              n.behaviourOn('node:dragstart', function (n) {
                ...
                (t = e.getDelegation([r], o)),
                  ...
                  e.set('bpmnNodePanStartPoint', { x: n.x, y: n.y }),
              ...
              n.behaviourOn('node:dragend', function (t) {
                ...
                i &&
                  i.getEdges().forEach(function (e) {
                    n.update(e, {
                      nodeMoved: { item: i.id, start: o, delta: { x: t.x - o.x, y: t.y - o.y } },
                    });
                  }),
                  r.remove(),
                  c();
          ...
          n.on('node:mouseenter', function (a) {
            if (!e.getSignal('panningItem') && !e.getSignal('dragEdge')) {
              var c = r.topArrow,
                ...
                l = r.rightArrow,
                d = (t = a.item).getBBox(),
                f = n.getDomPoint({ x: d.centerX, y: d.minY }),
                h = n.getDomPoint({ x: d.minX, y: d.centerY }),
                g = n.getDomPoint({ x: d.centerX, y: d.maxY }),
                p = n.getDomPoint({ x: d.maxX, y: d.centerY });
              c.css({
                top: f.y - (o + 10) + 'px',
                left: f.x - i / 2 + 'px',
                transform: 'rotate(-90deg)',
              }),
                u.css({ top: g.y + 10 + 'px', left: g.x - i / 2 + 'px', transform: 'rotate(90deg)' }),
                s.css({
                  top: h.y - i / 2 + 'px',
                  left: h.x - (o + 10) + 'px',
                  transform: 'rotate(180deg)',
                }),
                l.css({ top: p.y - i / 2 + 'px', left: p.x + 10 + 'px' }),
      ...
      function (e, t, n) {
        n(128), n(12).registerNode('bpmn-base', { anchor: null });
      },
      function (e, t, n) {
        'use strict';
        n.r(t);
        ...
        function a(e) {
          var t = e.bbox,
            ...
            i = e.vertical;
          i = !!i;
          var a = { true: 'x', false: 'y' },
            c = { true: 'minX', false: 'minY' },
            u = { true: 'maxX', false: 'maxY' };
          switch (r) {
            case 'ROUNDED_RECT':
                ...
                return {
                  ...
                  joint: {
                    x: i
                      ? o.x
                      : o.x > t.centerX
                      ? t.maxX - 4 + Math.sqrt(16 - Math.pow(t.minY + 4 - o.y, 2))
                      : t.minX + 4 - Math.sqrt(16 - Math.pow(t.minY + 4 - o.y, 2)),
                    y: i
                      ? o.y > t.centerY
                        ? t.maxY - 4 + Math.sqrt(16 - Math.pow(t.minX + 4 - o.x, 2))
                        : t.minY + 4 - Math.sqrt(16 - Math.pow(t.minX + 4 - o.x, 2))
                      : o.y,
                  },
                };
                ...
                return {
                  ...
                  joint: {
                    x: i
                      ? o.x
                      : o.x > t.centerX
                      ? t.maxX - 4 + Math.sqrt(16 - Math.pow(o.y - t.maxY + 4, 2))
                      : t.minX + 4 - Math.sqrt(16 - Math.pow(o.y - t.maxY + 4, 2)),
                    y: i
                      ? o.y > t.centerY
                        ? t.maxY - 4 + Math.sqrt(16 - Math.pow(o.x - t.maxX + 4, 2))
                        : t.minY + 4 - Math.sqrt(16 - Math.pow(o.x - t.maxX + 4, 2))
                      : o.y,
                  },
                };
              break;
                ...
                return {
                  ...
                  joint: {
                    x: i
                      ? o.x
                      : o.x > t.centerX
                      ? t.centerX + Math.sqrt(16 - Math.pow(t.centerY - o.y))
                      : t.centerX - Math.sqrt(16 - Math.pow(t.centerY - o.y)),
                    y: i
                      ? o.y > t.centerY
                        ? t.centerY + Math.sqrt(16 - Math.pow(t.centerX - o.x))
                        : t.centerY - Math.sqrt(16 - Math.pow(t.centerX - o.x))
                      : o.y,
                  },
                };
                ...
                return {
                  ...
                  joint: {
                    x: i
                      ...
                      : o.x > t.centerX
                      ? o.y < t.centerY
                        ? ((o.y - t.minY) * (t.maxX - t.centerX)) / (t.centerY - t.minY) + t.centerX
                        : ((t.maxY - o.y) * (t.maxX - t.centerX)) / (t.maxY - t.centerY) + t.centerX
                      : o.y < t.centerY
                      ? t.centerX - ((o.y - t.minY) * (t.centerX - t.minX)) / (t.centerY - t.minY)
                      : t.centerX - ((t.maxY - o.y) * (t.centerX - t.minX)) / (t.maxY - t.centerY),
                    y: i
                      ? o.y > t.centerY
                        ? o.x < t.centerX
                          ? ((o.x - t.minX) * (t.maxY - t.centerY)) / (t.centerX - t.minX) + t.centerY
                          : ((t.maxX - o.x) * (t.maxY - t.centerY)) / (t.maxX - t.centerX) + t.centerY
                        : o.x < t.centerX
                        ? t.centerY - ((o.x - t.minX) * (t.centerY - t.minY)) / (t.centerX - t.minX)
                        : t.centerY - ((t.maxX - o.x) * (t.centerY - t.minY)) / (t.maxX - t.centerX)
                      : o.y,
                  },
                };
              break;
          ...
          return i
            ? o.x < t.centerX
              ? { added: { x: o.x, y: t.centerY }, joint: { x: t.minX, y: t.centerY } }
              : { added: { x: o.x, y: t.centerY }, joint: { x: t.maxX, y: t.centerY } }
            : o.y < t.centerY
            ? { added: { x: t.centerX, y: o.y }, joint: { x: t.centerX, y: t.minY } }
            : { added: { x: t.centerX, y: o.y }, joint: { x: t.centerX, y: t.maxY } };
        }
        var c = n(20);
          ...
          getPath: function (e) {
            ...
            if (o.edgeMoved && o.lastMouse) {
              var u,
                ...
                g = o.hold.index,
                p = [
                  { x: h[g].x + o.edgeMoved.x, y: h[g].y + o.edgeMoved.y },
                  { x: h[g + 1].x + o.edgeMoved.x, y: h[g + 1].y + o.edgeMoved.y },
                ],
                m = Object(i.j)(p, 0);
              if (n) {
                var y = a({
              ...
              if (
                (0 === g && n && ((p[0] = l), s && (p.splice(1, 0, s), (e.model.hold.index += 1))), r)
              ) {
                var v = a({
                  bbox: r.getBBox(),
                  point: m,
              ...
              g === h.length - 2 &&
                r &&
                (s && 0 === g
                  ? ((p[2] = f), d && p.splice(2, 0, d))
                  : ((p[1] = f), d && p.splice(1, 0, d))),
                (u = o.controlPoints).splice.apply(u, [g, 2].concat(p)),
                n &&
                  Object(i.l)(l, h, o.hold.index) &&
                  (h.splice(0, o.hold.index), (o.hold.index = 0), (h[0] = l)),
                r &&
                  Object(i.l)(f, h, o.hold.index) &&
                  (o.controlPoints.splice(o.hold.index + 1), (h[o.hold.index + 1] = f)),
                ...
                (function (e, t, n) {
                  ...
                  if (t) {
                    var o = Object(i.f)(r[0], t.getBBox()),
                      a = o.point,
                      c = o.index;
                    e.sourceJoint = { index: c, delta: { x: r[0].x - a.x, y: r[0].y - a.y } };
                  }
                  if (n) {
                    ...
                    e.targetJoint = {
                      index: l,
                      delta: { x: r[r.length - 1].x - s.x, y: r[r.length - 1].y - s.y },
                    };
                  }
                })(o, n, r),
                (o.lastMouse = {
                ...
                if (e.nodeMoved) {
                  ...
                  if (2 === s.length) {
                    var l = Object(i.d)(t, n),
                      ...
                      f = l.targetPoint;
                    e.sourceJoint &&
                      d.index === e.sourceJoint.index &&
                      ((d.point = Object(i.c)(t.getBBox())[d.index]),
                      (d.point.x += e.sourceJoint.delta.x),
                      (d.point.y += e.sourceJoint.delta.y)),
                      e.targetJoint &&
                        f.index === e.targetJoint.index &&
                        ((f.point = Object(i.c)(n.getBBox())[f.index]),
                    ...
                    if (m === y) {
                      var b = Object(i.c)(a)[v.index],
                        x = { x: b.x + v.delta.x, y: b.y + v.delta.y },
                        S = Object(i.g)(x, s, g);
                      r
                        ? e.controlPoints.splice(0, 2, x, S)
                        : o && e.controlPoints.splice(g + 1, 2, S, x);
                    } else if (0 === y)
                      if (3 === s.length) {
                        ...
                        if (r) {
                          ...
                          e.controlPoints.splice(0, 3, k, A),
                            (e.sourceJoint = { index: C, delta: { x: 0, y: 0 } });
                        } else if (o) {
                          var M = Object(i.g)(k, s, g - 1);
                          e.controlPoints.splice(g, 3, M, k),
                            (e.targetJoint = { index: C, delta: { x: 0, y: 0 } });
                        }
                      }
                    else {
                      var B = Object(i.k)(v.index),
                        ...
                        X = Object(i.g)(j, s, g);
                      r
                        ? (e.controlPoints.splice(0, 2, j, X),
                          (e.sourceJoint = { index: B, delta: { x: 0, y: 0 } }))
                        : o &&
                          (e.controlPoints.splice(g + 1, 2, X, j),
                          (e.targetJoint = { index: B, delta: { x: 0, y: 0 } }));
                    }
                  }
                }
              })(o, n, r);
            ...
            return (
              (o.nodeMoved = void 0),
              { path: this.getPathByPoints({ points: o.controlPoints }), helpLine: t }
            );
          },
          draw: function (e) {
            var t = e.getGraphicGroup(),
            ...
            if (null != n.hold) {
              ...
              t.addShape('circle', { attrs: { x: s.x, y: s.y, r: 3, fill: 'rgb(0,182,239)' } });
            }
            return (
              a && ((n.helpLine = a), (n.helpLineTime = new Date().getTime())),
              !a &&
                new Date().getTime() - n.helpLineTime >= 150 &&
                ((n.helpLine = void 0), (n.helpLineTime = void 0)),
              n.helpLine &&
                t.addShape('path', {
                  attrs: {
                    path: [
                      ['M', n.helpLine[0].x, n.helpLine[0].y],
                      ['L', n.helpLine[1].x, n.helpLine[1].y],
                    ],
                    lineAppendWidth: 8,
                    lineWidth: 1,
                    strokeOpacity: 0.92,
